...
export class StudentShellComponent {
  readonly navItems: StudentNavItem[] = [
    ...
    { label: 'Results', route: `/${RouteAddress.Student.Results}`, icon: 'analytics', iconPath: 'assets/icons/nav/results.svg' },
    { label: 'Reports', route: `/${RouteAddress.Student.Reports}`, icon: 'assessment', iconPath: 'assets/icons/nav/reports.svg' }
  ];
